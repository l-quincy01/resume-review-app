...
public class AtsFinalAssessmentControllerTests
{
    [Fact]
    ...
    private static AtsFinalAssessmentController CreateController()
    {
        return new AtsFinalAssessmentController(new FinalAssessmentService());
    }
