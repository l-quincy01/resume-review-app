...
public sealed class AtsContextualKeywordScoringController : ControllerBase
{
    ...
    private readonly ILogger<AtsContextualKeywordScoringController> _logger;

    public AtsContextualKeywordScoringController(
        IResumeTextExtractor resumeTextExtractor,
        IContextualKeywordScoringService contextualKeywordScoringService,
        IOptions<OpenAiOptions> openAiOptions,
        ILogger<AtsContextualKeywordScoringController> logger)
    {
