...
public sealed class AtsEngineController : ControllerBase
{
    ...
    private readonly ILogger<AtsEngineController> _logger;

    public AtsEngineController(
        IResumeTextExtractor resumeTextExtractor,
        IStandardHeaderValidator standardHeaderValidator,
        IOptions<OpenAiOptions> openAiOptions,
        ILogger<AtsEngineController> logger)
    {
