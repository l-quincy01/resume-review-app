...
export const atsKeywordExtractionResponse = {
  ...
  keywords: [
    ...
    {
      keyword: "REST APIs",
      keyword_type: "multi_word",
      category: "technical_skill",
      tier: 1,
      requirement: "must_have",
      context: "Used to integrate frontend and backend systems.",
      variations: [],
      frequency: 1,
      boost_applied: false,
    },
    {
      ...
      context: "Used for containerized development and deployment.",
      variations: [],
      frequency: 1,
      boost_applied: false,
    },
...
export const atsKeywordScoringResponse = {
  keyword_scores: [
    ...
    {
      ...atsContextualScoringResponse.keyword_scores[2],
      requirement_multiplier: 1.15,
      context_points: 18,
      keyword_score: 21,
    },
    {
      ...atsContextualScoringResponse.keyword_scores[3],
      requirement_multiplier: 1.05,
      context_points: -12,
      keyword_score: 0,
    },
  ],
